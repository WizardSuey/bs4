...
with open("par1/index1.html", encoding="utf-8") as file:
    src = file.read()
...
# find_all_spans_in_info = soup.find(class_="user__info").find_all("span")
# print(find_all_spans_in_info)

# for item in find_all_spans_in_info:
#     print(item.text)

# print(find_all_spans_in_info[0])k
...
# next_el1 = soup.find(class_="post__title").find_next().text
# print(next_el1)
...
find_all_clotches = soup.find_all(string=re.compile("[Оо]дежда"))
print(find_all_clotches)